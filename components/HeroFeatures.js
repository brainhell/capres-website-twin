      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-800 mb-4">
            Servicios ofrecidos por CAPRES
          </h1>
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500">
            Pensando en sus asociados, CAPRES les ofrece la oportunidad de
            acceder a varios servicios. Entre ellos: préstamos personales,
            retiro parcial de haberes, etc.
          </p>
